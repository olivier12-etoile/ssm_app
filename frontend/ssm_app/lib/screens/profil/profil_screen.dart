...
class _ProfilScreenState extends State<ProfilScreen> {
  ...
  Future<void> _afficherDialogModifierNom() async {
    final nomController = TextEditingController(text: _profil?['nom'] ?? '');
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon(
                        ancienVisible ? Icons.visibility_off : Icons.visibility,
                      ),
                      onPressed: () =>
                          setStateDialog(() => ancienVisible = !ancienVisible),
                    ),
                  ),
                ),
              ...
              ElevatedButton(
                onPressed: () async {
                  if (ancienController.text.isEmpty ||
                      nouveauController.text.isEmpty)
                    return;
                  ...
                  try {
                    final response = await http.post(
                      Uri.parse('${AppConfig.apiBaseUrl}/profil/mot-de-passe'),
                      headers: await _headers(),
                      body: jsonEncode({
                    ...
                    if (response.statusCode == 200) {
                      ...
                      _afficherErreur(data['message'] ?? 'Erreur');
                    }
                  } catch (e) {
                    _afficherErreur(e.toString().replaceAll('Exception: ', ''));
                  }
              ...
              child: Column(
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundColor: const Color(0xFF1E3A8A),
                    child: Text(
                      (_profil!['nom'] as String).substring(0, 1).toUpperCase(),
                      style: GoogleFonts.sora(
                        fontSize: 32,
                      ...
                      children: [
                        ...
                        if (_profil!['ecole'] != null) ...[
                          ...
                          if (_profil!['ecole']['adresse'] != null)
                            SSMListeTile(
                              titre: 'Adresse',
                              sousTitre: _profil!['ecole']['adresse'] as String,
