...
<body>
    ...
    <div class="titre-section">ÉLÈVES NON EN RÈGLE</div>
    ...
    <table class="donnees">
        <thead>
            <tr>
                ...
                <th style="width: 30%;">Dette (FCFA)</th>
                <th style="width: 35%;">Absences non justifiées</th>
            </tr>
        </thead>
        <tbody>
            @foreach($eleves as $e)
            <tr>
                ...
                <td>{{ $e['motifs']['paiement']['montant_restant'] ?? '—' }}</td>
                <td>{{ $e['motifs']['absences']['nombre_absences_non_justifiees'] ?? '—' }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
